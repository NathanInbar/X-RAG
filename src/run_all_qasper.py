...
from xrag.utils.eval_gold import miner_evaluate_with_gold_answers, miner_evaluate_gold_bulk
...
if __name__ == "__main__":
    ...
    eval_routine = evaluate([
        ...
        #leanrag
        miner_evaluate_gold_bulk("leanrag-qasper-bulk", LeanragMINER(), DATASET)], 
